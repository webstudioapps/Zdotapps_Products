...
const ZQui = () => {
  ...
  const handleButtonClick = () => {
    navigate("/login"); // Redirects to z.qui login page
  };
    ...
    <section className={styles.hero}>
      <div className={styles.content}>
        ...
        <p className={styles.description}>
          Z.Qui helps educators and trainers create engaging quizzes and assessments. 
          Track progress, analyze results, and enhance learning outcomes with our 
          intuitive quiz platform.
        </p>
